<?php
	...
	if(isset($_POST['add_mem_btn'])){
		...
		//$sql="insert into member(mem_id,mem_name,mem_address,mem_gender,mem_email,man_id,p_id,t_id,b_id) values(membersq.nextval,'Nahin','Mirpur','Male','nahin@gmail.com',100,400,300,1)";
		...
		if($res){
			...
			<?php
			header('location: member_details_for_manager.php');
